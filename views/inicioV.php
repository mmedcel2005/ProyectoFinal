    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-custom">
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          ...
          print('<a class="nav-link" href="../controller/usuarioC.php"><img src="' . $_SESSION['imagen'] . '" alt="Imagen de usuario" class="rounded-circle usuario-imagen" style="max-width: 30px;" />');
            ...
            <div class="card mb-4 bg-custom-sec">
              <div class="card-body text-center bg-custom-sec ">
                <div class="d-flex justify-content-between ">
                  ...
                  <form action="../index.php" method="post">
                    <button class="btn  flex-fill mx-2 pt-2 pb-2 text-muted rounded-1 btn-bg-custom" name="categoria" id="categoria" value="F">FIGURAS</button>
                  </form>
                  <form action="../index.php" method="post">
                    <button class="btn  flex-fill mx-2 pt-2 pb-2 text-muted rounded-1 btn-bg-custom" name="categoria" id="categoria" value="A">ACCESORIOS</button>
                  </form>
                  <form action="../index.php" method="post">
                    <button class="btn  flex-fill mx-2 pt-2 pb-2 text-muted rounded-1 btn-bg-custom" name="categoria" id="categoria" value="N">NUEVO</button>
                  </form>
                  <form action="../index.php" method="post">
                    <button class="btn flex-fill mx-2 pt-2 pb-2 text-muted rounded-1 btn-bg-custom" name="categoria" id="categoria" value="O">OFERTAS</button>
                  </form>
                </div>
              </div>
            </div>
