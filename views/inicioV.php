...
<body>
      ...
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          <ul class="navbar-nav me-auto mb-2 mb-lg-0">
            <li class="nav-item">
              <a class="nav-link active" href="../index.php"><b>Mistery Boxes</b></a>
            </li>
  ...
  <main>
    ...
    <article>
      <div class="container">
        <div class="spinner-border position-relative top-50 start-50 translate-middle text-token" role="status">
          <span class="visually-hidden sr-only">Cargando...</span>
        </div>
        <div class="row d-none" id="cajas">
          ...
          foreach ($datosCajas as $caja) {
            ...
            print('    <h4 class="card-text text-token">' . $caja["precio"] . '</h5>');
