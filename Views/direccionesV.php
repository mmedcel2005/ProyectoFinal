        ...
        <div class="row">
          <div class="col-sm-4 mb-3">
            <div class="card position-relative text-center bg-custom-sec">
              <div class="card-body">
                <p class="card-text text-muted">Nombre Apellidos  </p>
                <p class="card-text text-muted">Calle nº  </p>
                <p class="card-text text-muted">Ciudad,Provincia, Cod  </p>
                <p class="card-text text-muted">Pais  </p>
                <p class="card-text text-muted">Calle nº  </p>
              </div>
            </div>
          </div>
