...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `proyecto`.`Objeto` ;
...
-- Table `proyecto`.`Caja`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `proyecto`.`Caja` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `proyecto`.`Objeto_has_Caja` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `proyecto`.`CompraDeToken` ;
...
CREATE TABLE IF NOT EXISTS `proyecto`.`CompraDeToken` (
  ...
  INDEX `fk_CompraDeToken_Usuario1_idx` (`Usuario_idUsuario` ASC) VISIBLE,
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `proyecto`.`PackToken` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `proyecto`.`CompraDeToken_has_PackToken` ;
...
CREATE TABLE IF NOT EXISTS `proyecto`.`CompraDeToken_has_PackToken` (
  ...
  INDEX `fk_CompraDeToken_has_PackToken_PackToken1_idx` (`PackToken_idPackToken` ASC) VISIBLE,
  INDEX `fk_CompraDeToken_has_PackToken_CompraDeToken1_idx` (`CompraDeToken_idCompraToken` ASC, `CompraDeToken_Usuario_idUsuario` ASC) VISIBLE,
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `proyecto`.`Inventario_has_Objeto` ;
...
CREATE TABLE IF NOT EXISTS `proyecto`.`Inventario_has_Objeto` (
  ...
  INDEX `fk_Inventario_has_Objeto_Objeto1_idx` (`Objeto_idObjeto` ASC) VISIBLE,
  INDEX `fk_Inventario_has_Objeto_Inventario1_idx` (`Inventario_idInventario` ASC, `Inventario_Usuario_idUsuario` ASC) VISIBLE,
  CONSTRAINT `fk_Inventario_has_Objeto_Inventario1`
    FOREIGN KEY (`Inventario_idInventario` , `Inventario_Usuario_idUsuario`)
    REFERENCES `proyecto
  `.`Inventario` (`idInventario` , `Usuario_idUsuario`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `proyecto`.`metodoPago` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `proyecto`.`Enviados` ;

CREATE TABLE IF NOT EXISTS `proyecto`.`Enviados` (
  `numEnviados` INT NOT NULL,
  `fecha_Envio` DATE NULL,
  `estadoEnvio` VARCHAR(45) GENERATED ALWAYS AS () VIRTUAL,
  `Usuario_idUsuario` INT NOT NULL,
  PRIMARY KEY (`numEnviados`, `Usuario_idUsuario`),
  INDEX `fk_Enviados_Usuario1_idx` (`Usuario_idUsuario` ASC) VISIBLE,
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `proyecto`.`Enviados_has_Objeto` ;
...
CREATE TABLE IF NOT EXISTS `proyecto`.`Enviados_has_Objeto` (
  ...
  INDEX `fk_Enviados_has_Objeto_Objeto1_idx` (`Objeto_idObjeto` ASC) VISIBLE,
  INDEX `fk_Enviados_has_Objeto_Enviados1_idx` (`Enviados_idEnviados` ASC) VISIBLE,
  CONSTRAINT `fk_Enviados_has_Objeto_Enviados1`
    FOREIGN KEY (`Enviados_idEnviados`)
    REFERENCES `proyecto
  `.`Enviados` (`numEnviados`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
